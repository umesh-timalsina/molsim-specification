"""
This script is called by the plugin-wrapper, createSystems.js, which passes down the
...
from createSystems import createSystems
...
plugin = createSystems(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
